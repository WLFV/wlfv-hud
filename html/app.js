...
$(document).on('click', '.save-bindings', function(e){
    ...
    $.post('https://wlfv-commandbinding/save', JSON.stringify({
        keyData: keyData
    }));
});
...
qBinding.Close = function() {
    ...
    $.post('https://wlfv-commandbinding/close');
}
...
function closeMenu() {
  ...
  $.post('https://wlfv-hud/closeMenu');
}
function restartHud() {
  closeMenu()
  $.post('https://wlfv-hud/restartHud');
}
function resetStorage() {
  closeMenu()
  $.post('https://wlfv-hud/resetStorage');
}
function showOutMap() {
  $.post('https://wlfv-hud/showOutMap');
}
function showOutCompass() {
  $.post('https://wlfv-hud/showOutCompass');
}
function showFollowCompass() {
  $.post('https://wlfv-hud/showFollowCompass');
}
function openMenuSounds() {
  $.post('https://wlfv-hud/openMenuSounds');
}
function resetHudSounds() {
  $.post('https://wlfv-hud/resetHudSounds');
}
function checklistSounds() {
  $.post('https://wlfv-hud/checklistSounds');
}
function showMapNotif() {
  $.post('https://wlfv-hud/showMapNotif');
}
function showFuelAlert() {
  $.post('https://wlfv-hud/showFuelAlert');
}
function showCinematicNotif() {
  $.post('https://wlfv-hud/showCinematicNotif');
}
function dynamicHealth() {
  $.post('https://wlfv-hud/dynamicHealth');
}
function dynamicArmor() {
  $.post('https://wlfv-hud/dynamicArmor');
}
function dynamicHunger() {
  $.post('https://wlfv-hud/dynamicHunger');
}
function dynamicThirst() {
  $.post('https://wlfv-hud/dynamicThirst');
}
function dynamicStress() {
  $.post('https://wlfv-hud/dynamicStress');
}
function dynamicOxygen() {
  $.post('https://wlfv-hud/dynamicOxygen');
}
function dynamicEngine() {
  $.post('https://wlfv-hud/dynamicEngine');
}
function dynamicNitro() {
  $.post('https://wlfv-hud/dynamicNitro');
}
function ToggleMapShape() {
  $.post('https://wlfv-hud/ToggleMapShape');
}
function changeFPS() {
  $.post('https://wlfv-hud/changeFPS');
}
function ToggleMapBorders() {
  $.post('https://wlfv-hud/ToggleMapBorders');
}
function HideMap() {
  $.post('https://wlfv-hud/HideMap');
}
function changeCompassFPS() {
  $.post('https://wlfv-hud/changeCompassFPS');
}
function showCompassBase() {
  $.post('https://wlfv-hud/showCompassBase');
}
function showStreetsNames() {
  $.post('https://wlfv-hud/showStreetsNames');
}
function showPointerIndex() {
  $.post('https://wlfv-hud/showPointerIndex');
}
function showDegreesNum() {
  $.post('https://wlfv-hud/showDegreesNum');
}
function cinematicMode() {
  $.post('https://wlfv-hud/cinematicMode');
}
